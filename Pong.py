...
dummy_ball_vel_x, dummy_ball_vel_y = 1, 1
...
while run:
    ...
    if left_gadget == 1:
        pygame.draw.circle(wn, WHITE, (second_left_paddle_x + 10, second_left_paddle_y + 10), 4)
    if right_gadget == 1:
        pygame.draw.circle(wn, WHITE, (second_right_paddle_x + 10, second_right_paddle_y + 10), 4)
